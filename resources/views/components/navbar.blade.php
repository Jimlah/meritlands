<nav class="px-5 flex items-center justify-between w-full static md:px-10 text-gray-700 dark:text-gray-200" x-data="dropdown">
    ...
    <div class="flex items-center space-x-2 static" x-data="darkmode">
        ...
        <button x-on:click="toggle" class="">
